 ...
 * into Supabase as a published row. Auth bypassed (deleted in the next commit).
 * Used to re-seed 001/002/003 after the Feynman story-flow restructure.
    ...
    .upsert(
      {
        ...
        slug: parsed.slug,
        // Don't override published_at on existing rows — keep their original
        // publish timestamp. status stays whatever it was; if currently draft,
        // it stays draft (separate publish step).
